...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = (abs(_row1 - _row0) == 1 && abs(_col1 - _col0) == 0)
                || (abs(_row1 - _row0) == 0 && abs(_col1 - _col0) == 1)
                || (abs(_row1 - _row0) == 1 && abs(_col1 - _col0) == 1);
        _isJump = !_isExtend
                && ((abs(_row1 - _row0) == 2 && abs(_col1 - _col0) == 0)
                || (abs(_row1 - _row0) == 0 && abs(_col1 - _col0) == 2)
                || (abs(_row1 - _row0) == 2 && abs(_col1 - _col0) == 2)
                || (abs(_row1 - _row0) == 1 && abs(_col1 - _col0) == 2)
                || (abs(_row1 - _row0) == 2 && abs(_col1 - _col0) == 1));
    }
    private Move(char col0, char row0, char col1, char row1) {
        _col0 = col0;
        _row0 = row0;
        _col1 = col1;
        _row1 = row1;
        _fromIndex = Board.index(col0, row0);
        _toIndex = Board.index(col1, row1);
        _isExtend = (abs(_row1 - _row0) == 1 && abs(_col1 - _col0) == 0)
                || (abs(_row1 - _row0) == 0 && abs(_col1 - _col0) == 1)
                || (abs(_row1 - _row0) == 1 && abs(_col1 - _col0) == 1);
        _isJump = !_isExtend
     ...
     *  row positions. */
    protected static final Move[][][][] ALL_MOVES =
